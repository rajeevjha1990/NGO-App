...
@Component({
  selector: 'app-program-employment',
  templateUrl: './program-employment.page.html',
  styleUrls: ['./program-employment.page.scss'],
  standalone: true,
  imports: [...SHARED_IONIC_MODULES],
})
export class ProgramEmploymentPage implements OnInit {
